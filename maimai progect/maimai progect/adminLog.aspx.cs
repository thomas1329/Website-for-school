            ...
            else
            {
                ...
                if (Request.Form["submit"] != null)//אם נלחץ SEND
                {
...

                    {
                        ...
                        sql = string.Format("insert into Users (name,pass,email,adress,age,fn,ln,isAdmin)" +
                           " VALUES('{0}','{1}','{2}','{3}','{4}','{5}','{6},'{7}')", name, password, basketballTEAM, "N'" + adress + "'", age, fname, lname,isAdmin);
                        ...
                        sql = "INSERT INTO Users(name,pass,basketballTEAM,adress,age,fn,ln,isAdmin)";//עמודות במסד הנתונים
                                                                                             ...
                                                                                             //  מציינת -Unicode.
                        sql += "VALUES(N'" + name + "',N'" + password + "',N'" + basketballTEAM + "',N'" + adress + "',N'" + age + "',N'" + fname + "',N'" + lname + "',N'"+isAdmin+ "')";
                ...
                if (Request.Form["edit"] != null)//אם נלחץ כפתור edit
                {
                    string name = Request.Form["name"];
